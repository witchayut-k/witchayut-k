...
- <b>Full Stack Development </b>
  ...
  - Shiseido CRM Integration _–Line OA_  
    _(Angular, Nodejs, Firebase)_
  - Interactive Web Plugin _–Voice/Video calling, chat, screen sharing_  
    _(React, C#.net)_
  - NRIIS Project _–Thai Government R&D Portal_  
    _(C#.net, React, React Native)_
  - Online Travel Ticketing Platform  
    _(Laravel, Ionic Angular)_
  - Security Guard Checkpoint System _–Real-time alerts via LineOA & Telegram_  
    _(React Native, Laravel)_
  - Herbal Medicinal Database _–Custom CMS for Manose Co_  
    _(Laravel)_
  - POS System for Currency Exchange _–Chiang Mai Money Exchange_  
    _(PHP)_
 
- <b>Frontend Development </b>
  - Carbon Footprint _–Line OA (Kasikorn Bank)_  
    _(Ionic Angular)_
  - MEA Hospital Management System _–Patient Referral & Social Work Modules_  
    _(Angular)_
